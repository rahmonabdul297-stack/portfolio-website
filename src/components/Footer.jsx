export default function Footer({ name }) {
  return (
    <footer className="border-t border-white/5 bg-[#222] px-6 lg:px-8 relative">
      <div
      ...
      <div className="max-w-7xl mx-auto py-16 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full border border-[#F1E7D6]/30 flex items-center justify-center bg-[#F1E7D6]/5">
            <img
          ...
          <span className="font-serif text-sm text-white/90 uppercase">
            {name}
          </span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a
            ...
            className="text-sm text-[var(--primary)] hover:text-[#FFF] transition-colors"
          >
            GitHub
          </a>
          <a
            href="https://www.linkedin.com/in/abdul-rahmon-91b451359/"
            className="text-sm text-[var(--primary)] hover:text-[#FFF] transition-colors"
          >
            LinkedIn
          </a>
          <a
            href="https://x.com/Rahmon00007"
            className="text-sm text-[var(--primary)] hover:text-[#FFF] transition-colors"
          >
            Twitter/X
          </a>
