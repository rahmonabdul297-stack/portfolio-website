        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          <div className="lg:col-span-7 scroll-reveal">
            ...
            <div className="space-y-6 text-base leading-relaxed text-white/50">
              ...
              <p>
                From developing robust APIs and microservices to crafting
                responsive, state-driven user interfaces, I navigate the entire
                web stack. I believe in clean architecture that speaks volumes
                and systems that scale effortlessly.
              </p>
            </div>
          </div>
